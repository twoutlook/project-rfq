...
//    echo "<h1>$result_path</h1>";
    ...
    $result_path.="results/RFQ-MEX-" . $stamp . ".xlsx";
...
$stamp = time();
$defaultOutputFile = pathinfo(__FILE__, PATHINFO_DIRNAME) . DIRECTORY_SEPARATOR . "results" . DIRECTORY_SEPARATOR . "RFQ-MEX-$stamp.xlsx";
...
//
// 2016/5/27 requested by Jason , to extend current RFQ to MEX
//
$objPHPExcel->getActiveSheet()
->setCellValue('A7', 'RFQ')
->setCellValue('A8', 'MEX');
