...
//            
            ...
            {sheet: 1, row: 45, col: 2, json: {data: "Lobor cost/ shot 人工费/模 ： "}},
...
//            {sheet: 1, row: 58, col: 3, json: {data: ""}},
            ...
            {sheet: 1, row: 63, col: 2, json: {data: "Lobor cost/pc 人工费/只 "}},
...
//            {sheet: 1, row: 69, col: 3, json: styleSubTotal({data: "=IF(ISNA((C66/3600)*C67 * (1 + (1 - C68 / 100))),0,(C66/3600)*C67 * (1 + (1 - C68 / 100)))"})},
            ...
            {sheet: 1, row: 71, col: 2, json: {data: "Time(s)/pc工时（秒）/只 ： "}},
...
//            {sheet: 1, row: 77, col: 3, json: {bgc: colorStepEnd, fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C75/3600)*C76"}},
            ...
            {sheet: 1, row: 102, col: 2, json: {data: "Lobor cost/pc 人工费率/H： "}},
...
//            {sheet: 1, row: 114, col: 3, json: {fm: "money|$|2|none", dsd: "ed", cal: true, data: "=(C111/6.35)"}},
            ...
            {sheet: 1, row: 113, col: 1, json: {data: "Total Cost per part (RMB with VAT) :生成", it: "button", btnStyle: "color: blue; font-weight: bold;", onBtnClickFn: "CUSTOM_BUTTON_CLICK___MAKE_EXCEL"}},
...
//          // 只是做成最後一行
            ...
            {sheet: 1, row: 8, col: 1, json: {bgc: colorVersion, data: 'A0606'}},
